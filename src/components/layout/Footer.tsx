        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-gray-300">
              Email: info@navioxbd.com<br />
              Website: navioxbd.com
            </p>
          </div>
          <p className="mt-8 text-xs leading-5 text-gray-500 lg:mt-0">
            &copy; 2025 NavioX Solutions Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
