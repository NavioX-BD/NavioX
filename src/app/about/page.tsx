...
import { loadAboutData, loadCompanyStats } from '@/lib/data-loader'
import {
  BeakerIcon, ChartBarIcon, GlobeAltIcon, HeartIcon,
  LightBulbIcon, RocketLaunchIcon, ShieldCheckIcon, StarIcon, UserGroupIcon
...
export default function AboutPage() {
  ...
  const { coreValues, milestones } = loadAboutData()
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            >
              About NavioX Solutions
            </motion.h1>
            <motion.p
              variants={itemVariants}
              className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto"
            >
              We are the digital navigators who multiply your business potential through excellence in software engineering.
            </motion.p>
            <motion.div
              variants={itemVariants}
            ...
            >
              ...
              <span className="text-blue-100">Your Digital Compass in the Software Engineering Ocean</span>
            </motion.div>
          </motion.div>
        </div>
      </motion.section>
              ...
              <div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Discover our journey and learn more about our mission and values.
                  </p>
